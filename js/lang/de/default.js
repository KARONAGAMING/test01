...
var langIndex = {
	...
	'langVersionAvailable': "milkAdmin v_VER_ ist verfügbar!", // milkAdmin v1.0 is available
	...
	'langBanListSM': "Bannliste",
	'langWhitelistSM': "Whitelist",
	///////////////////
	//	Server Info
	///////////////////
	'langLastRestart': "Letzter Neustart",
	'langAmountPlayersOnline': "Anzahl der Spieler, die online sind",
	...
	'langTitleSpace': "Platzverbrauch - Basierend auf dem &quot;Backup Ordner&quot; Verzeichnis.",
	...
	'langBroadcastMessage': "Server-Nachricht",
	'langTitleBroadcastMessage': "Server Nachricht - Sendet eine Nachricht an alle Spieler ohne Tags",
	'langLevelName': "Hauptlevel-Name",
	'langTitleLevelName': "Der Wert wird als Welt- und Ordnername verwendet.<br>Sie können auch ihren Speicherordner an diesen Ort kopieren, und den Namen angleichen, um diesen anstelle des anderen Ordners zu laden.",
	'langMCIPPORT': "Minecraft Server IP und Port",
	'langTitleMCIPPORT': "<b>IP:</b> Legt eine IP fest, wenn der Server zu einer bestimmten IP gehören soll (Bsp. Wenn es mehrere IP\'s gibt zu diesem Server/PC). Es wird dringend empfohlen, das Feld server-ip leer zu lassen!<br><b>Port:</b> Änderungen des Ports vom Server auf dem der Server läuft. Dieser Port muss weitergeleitet, wenn der Server/PC sich hinter einen Router befindet.<br><b>Gültige Werte:</b><ul><li><b>IP:</b> Das Feld Leer lassen, oder die IP vom Server eingeben.</li><li><b>Port:</b> Eine Zahl zwischen <b>1-65535</b>. Default: <b>25565</b><ul><li>Der Port sollte größer sein als 20000, um Konflikte mit den reservierten System Ports zu vermeiden.</li></ul></li></ul>",
	'langMaxPlayers': "Maximale Spieler",
	'langTitleMaxPlayers': "Die Maximale Anzahl von Spielern, die auf dem Server zur gleichen Zeit spielen können.<br><i>Beachte, dass wenn mehr Spieler auf dem Server sind, werden mehr Ressourcen genutzt.</i><br><i>Beachte außerdem, Admin Verbindungen werden nicht auf die Maximale Spieler gezählt (Server Voll = Voll).</i><br><b>Gültige Werte:</b><ul><li>Eine Zahl zwischen <b>0-255</b>.</li></ul>",
	'langViewDistance': "Sichtweite",
	'langTitleViewDistance': "Die Menge an Blöcke die der Server an die Spieler sendet.<br><b>Gültige Werte:</b><ul><li>Eine Zahl zwischen <b>3-15</b>. Default: <b>10</b></li></ul>",
	'langHoldMessage': "Halte Nachricht",
	'langTitleHoldMessage': "Nachricht die MCSODRTK anzeigen wird, wenn der Server angehalten ist. <br><i>Benötigt das MinecraftRemoteToolkit</i>",
	'langAllowNether': "Nether Erlauben",
	'langTitleAllowNether': "Erlaubt es Spielern, in den Nether zu reisen und ihn zu benutzen.<ul><li><b>An</b> = Der Server erlaubt es, das Portale benutzt werden können, um Spieler zum Nether reisen zu lassen.</li><li><b>Aus</b> = Der Server verbietet es, Portale zu benutzen.</li></ul> ",
	'langSpawnMonsters': "Monster spawnen",
	'langTitleSpawnMonsters': "Stell auf \"true\", wenn Monster, in der Nacht erzeugt werden sollen \"false\" wenn keine erzeugt werden sollen.<br><i>Tipp: Wenn es große Lag\'s gibt, schalte die Monster wieder aus.</i><ul><li><b>true</b> = Monster werden in der Nacht und in der Dunkelheit erscheinen.</li><li><b>false</b> = Keine Monster.</li></ul>",
	'langSpawnAnimals': "Tiere spawnen",
	'langTitleSpawnAnimals': "Tiere werden auf dem Server erzeugt<ul><li><b>true</b> = Tiere werde auf dem Server gespawnt.</li><li><b>false</b> = Tier werden nicht gespawnt.</li></ul>",
	'langOnlineMode': "Online Modus (Namen verifizieren)",
	'langTitleOnlineMode': "Der Server fragt die Minecraft Datenbank ab, ob die Account\'s der Spieler Gültig sind.<br>Nur auf \"false\" stellen, wenn der Server nicht mit dem Internet verbunden ist.<ul><li><b>true</b> = Der Server fragt, Beim Verbinden des Spielers sein Accounts bei minecraft.net ab, ob er Gültig ist.</li><li><b>false</b> = Der Server wird den Account des Spielers, nicht abfragen.</li></ul>",
	'langPVP': "Spieler gegen Spieler (PVP)",
	'langTitlePVP': "Aktiviert Spieler gegen Spieler auf dem Server.<br><i>Hinweis: Schlägt man einen Spieler, der gezähmte Wölfe hat werden die Wölfe einen <br> Angriff auf den angegriffen Spieler machen.</i><ul><li><b>true</b> = Die Spieler können sich gegenseitig töten.</li><li><b>false</b> = Spieler können andere Spieler nicht töten.</li></ul>",
	'langAllowFlight': "Fliegen erlauben",
	'langTitleAllowFlight': "Die Benutzer können Fliegen und no-Clip auf dem Server verwenden, wenn sie eine Mod, installiert haben die Fliegen und no-Clip zulassen.<ul><li><b>true</b> = Fliegen und no-Clip ist erlaubt, und kann benutzt werden, wenn die Spieler eine Mod installiert haben.</li><li><b>false</b> = Fliegen und no-Clip ist nicht erlaubt.</li></ul>",
	'langWhitelist': "Whitelist",
	'langTitleWhitelist': "Aktiviert eine White-list auf dem Server. Bei einer aktivierten Whitelist, werden die Nutzer die nicht auf der White-list Stehen keine Verbindung zum Server herstellen können.<ul><li><b>true</b> = Die white-list.txt wird verwendet.</li><li><b>false</b> = Keine White-list.txt wird verwendet.</li></ul>",
	///////////////////
	//	Whitelist
	///////////////////
	'langWhitelistSM': "Whitelist",
	...
	'langWLSaveChanges': "Änderungen speichern",
	///////////////////
	//	Plugin Panel
	///////////////////
	...
	'langRestoreBackup': "Sicherung wiederherstellen",
	'langDeleteBackup': "Sicherung Löschen",
	'langBackupClear': "Entfernen Sie die vorherigen Ordner vor dem Wiederherstellen der Sicherung",
	///////////////////
	//	Players
	///////////////////
...
var jsIndex = {
	...
	'RTKNeeded': "Braucht das RemoteToolkit, um diese Funktion zu nutzen!",
	...
	'UnknownError': "Unbekannter Fehler! Versuche es erneut!",
	'NotResponse': "Server antwortet nicht! Versuche es erneut!",
...
var jsAjax = {
	...
	'wladdfail': "Spieler zur Whitelist hinzuzufügen ist fehlgeschlagen!",
	'wlsavefail': "Speichern der Whitelist fehlgeschlagen! Versuche es erneut!",
...
var jsBackup = {
	'Complete': "Sicherung vollständig! Server wird gestartet...",
	'UnknownError': "Unbekannter Fehler! Versuche es erneut!",
	'NotResponse': "Server antwortet nicht! Versuche es erneut!"
};